...
namespace TravelInspiration.API.Migrations
{
    ...
    [Migration("20251011071640_SetupTablesData")]
    partial class SetupTablesData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TravelInspiration.API.Shared.Domain.Entities.Itinerary", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2025, 10, 11, 7, 16, 39, 961, DateTimeKind.Utc).AddTicks(2977),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2025, 10, 11, 7, 16, 39, 961, DateTimeKind.Utc).AddTicks(3244),
            ...
            modelBuilder.Entity("TravelInspiration.API.Shared.Domain.Entities.Stop", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2025, 10, 11, 7, 16, 39, 963, DateTimeKind.Utc).AddTicks(3332),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2025, 10, 11, 7, 16, 39, 963, DateTimeKind.Utc).AddTicks(4406),
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2025, 10, 11, 7, 16, 39, 963, DateTimeKind.Utc).AddTicks(4424),
                        ...
                        new
                        {
                            Id = 4,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2025, 10, 11, 7, 16, 39, 963, DateTimeKind.Utc).AddTicks(4429),
                        ...
                        new
                        {
                            Id = 5,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2025, 10, 11, 7, 16, 39, 963, DateTimeKind.Utc).AddTicks(4432),
                        ...
                        new
                        {
                            Id = 6,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2025, 10, 11, 7, 16, 39, 963, DateTimeKind.Utc).AddTicks(4437),
